...
main.py
-------
Headless CLI for Circadian LED controller — use when SSH-ing into the Pi
without a display attached.

Usage:
  python3 main.py
  python3 main.py --date 2025-12-21 --leds 60
"""
...
def main():
    ...
    parser.add_argument("--interval", type=int, default=30, help="LED update interval in seconds")
    ...
    # Calculate sun times using fixed Canada average
    ...
    # Run LED loop (suppress prints for headless mode)
    led_controller.run_loop(
        ...
        verbose=False  # suppress terminal prints
    )
